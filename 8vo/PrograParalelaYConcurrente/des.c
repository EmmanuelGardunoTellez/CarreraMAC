...
int initial_key_permutaion[] = {57, 49,  41, 33,  25,  17,  9, //PC-1 Permuted choise one
								 1, 58,  50, 42,  34,  26, 18,
								10,  2,  59, 51,  43,  35, 27,
								19, 11,   3, 60,  52,  44, 36,
...
int initial_message_permutation[] =	   {58, 50, 42, 34, 26, 18, 10, 2, //Permitacion inicial
...
int key_shift_sizes[] = {-1, 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1}; //rotacion de bits

int sub_key_permutation[] =    {14, 17, 11, 24,  1,  5,  //PC-2 Permuted choise two
								 3, 28, 15,  6, 21, 10,
								23, 19, 12,  4, 26,  8,
								16,  7, 27, 20, 13,  2,
								41, 52, 31, 37, 47, 55,
...
int message_expansion[] =  {32,  1,  2,  3,  4,  5, //E (usado para expandir) r_1
							 4,  5,  6,  7,  8,  9,
							 8,  9, 10, 11, 12, 13,
							12, 13, 14, 15, 16, 17,
							16, 17, 18, 19, 20, 21,
...
int S1[] = {14,  4, 13,  1,  2, 15, 11,  8,  3, 10,  6, 12,  5,  9,  0,  7, //Sub-box 1
			 0, 15,  7,  4, 14,  2, 13,  1, 10,  6, 12, 11,  9,  5,  3,  8,
			 4,  1, 14,  8, 13,  6,  2, 11, 15, 12,  9,  7,  3, 10,  5,  0,
			15, 12,  8,  2,  4,  9,  1,  7,  5, 11,  3, 14, 10,  0,  6, 13};

int S2[] = {15,  1,  8, 14,  6, 11,  3,  4,  9,  7,  2, 13, 12,  0,  5, 10, //Sub-box 2
			 3, 13,  4,  7, 15,  2,  8, 14, 12,  0,  1, 10,  6,  9, 11,  5,
			 0, 14,  7, 11, 10,  4, 13,  1,  5,  8, 12,  6,  9,  3,  2, 15,
			13,  8, 10,  1,  3, 15,  4,  2, 11,  6,  7, 12,  0,  5, 14,  9};

int S3[] = {10,  0,  9, 14,  6,  3, 15,  5,  1, 13, 12,  7, 11,  4,  2,  8, //Sub-box 3
			13,  7,  0,  9,  3,  4,  6, 10,  2,  8,  5, 14, 12, 11, 15,  1,
			13,  6,  4,  9,  8, 15,  3,  0, 11,  1,  2, 12,  5, 10, 14,  7,
			 1, 10, 13,  0,  6,  9,  8,  7,  4, 15, 14,  3, 11,  5,  2, 12};

int S4[] = { 7, 13, 14,  3,  0,  6,  9, 10,  1,  2,  8,  5, 11, 12,  4, 15, //Sub-box 4
			13,  8, 11,  5,  6, 15,  0,  3,  4,  7,  2, 12,  1, 10, 14,  9,
			10,  6,  9,  0, 12, 11,  7, 13, 15,  1,  3, 14,  5,  2,  8,  4,
			 3, 15,  0,  6, 10,  1, 13,  8,  9,  4,  5, 11, 12,  7,  2, 14};

int S5[] = { 2, 12,  4,  1,  7, 10, 11,  6,  8,  5,  3, 15, 13,  0, 14,  9, //Sub-box 5
			14, 11,  2, 12,  4,  7, 13,  1,  5,  0, 15, 10,  3,  9,  8,  6,
			 4,  2,  1, 11, 10, 13,  7,  8, 15,  9, 12,  5,  6,  3,  0, 14,
			11,  8, 12,  7,  1, 14,  2, 13,  6, 15,  0,  9, 10,  4,  5,  3};

int S6[] = {12,  1, 10, 15,  9,  2,  6,  8,  0, 13,  3,  4, 14,  7,  5, 11, //Sub-box 6
			10, 15,  4,  2,  7, 12,  9,  5,  6,  1, 13, 14,  0, 11,  3,  8,
			 9, 14, 15,  5,  2,  8, 12,  3,  7,  0,  4, 10,  1, 13, 11,  6,
			 4,  3,  2, 12,  9,  5, 15, 10, 11, 14,  1,  7,  6,  0,  8, 13};

int S7[] = { 4, 11,  2, 14, 15,  0,  8, 13,  3, 12,  9,  7,  5, 10,  6,  1, //Sub-box 7
			13,  0, 11,  7,  4,  9,  1, 10, 14,  3,  5, 12,  2, 15,  8,  6,
			 1,  4, 11, 13, 12,  3,  7, 14, 10, 15,  6,  8,  0,  5,  9,  2,
			 6, 11, 13,  8,  1,  4, 10,  7,  9,  5,  0, 15, 14,  2,  3, 12};

int S8[] = {13,  2,  8,  4,  6, 15, 11,  1, 10,  9,  3, 14,  5,  0, 12,  7, //Sub-box 8
...
//simplemete pasa un cadena de texto a binario
//lo imprime en consola la comparacion con este y el texto inicial
...
//asigna un byte (8bits) de manera aleatoria para la llave no mayor a 255
...
//muestra la llave k, c y d del algoritmo 
// ademas de pasarlo a binario
void print_key_set(key_set key_set){
	...
	for (i=0; i<8; i++) {
		...
		//manda el valor para convertir a binario
...
//divide la llave K en la mitad de C y D
//se basa a las matrices de arriba
void generate_sub_keys(unsigned char* main_key, key_set* key_sets) {
	int i, j;
	int shift_size;
	unsigned char shift_byte, first_shift_bits, second_shift_bits, third_shift_bits, fourth_shift_bits;
	// llena la primera llaves con ceros
	for (i=0; i<8; i++) {
		key_sets[0].k[i] = 0;
	}
	// genera la llave usando la tabla inicial
	// aqui un poco mas de cosas
	for (i=0; i<56; i++) {
	...
	//Genera las demas llaves (16) round key
	for (i=1; i<17; i++) {
		for (j=0; j<4; j++) {
		...
		//round key shiife para la transpuesta
		for (j=0; j<48; j++) {
...
void process_message(unsigned char* message_piece, unsigned char* processed_piece, key_set* key_sets, int mode) {
	...
	//dibide los valores de la permutacion final en 2 (left right)
	...
	//pasando los valores en las 2 mitades iguales
	int key_index;
	for (k=1; k<=16; k++) {
		memcpy(ln, r, 4);

		memset(er, 0, 6);
		//Expande R_i a 48 bits
		for (i=0; i<48; i++) {
		...
		//Elije que va a hacer el codigo
		if (mode == DECRYPTION_MODE) {
			key_index = 17 - k;
		} else {
			key_index = k;
		}
		//operacion XOR encriptar o desencriptar depediendo de lo que se necesite
		for (i=0; i<6; i++) {
			er[i] ^= key_sets[key_index].k[i]; //XOR
		}
		...
		// las colum y filas de para sustituairlas de las cajas 
		
		// 0000 0000 0000 0000 0000 0000
		// rccc crrc cccr rccc crrc cccr
		//Operaciones con las sub-boxes para reducirlo a 32bits
		// Byte 1
		row = 0;
		row |= ((er[0] & 0x80) >> 6);
		row |= ((er[0] & 0x04) >> 2);
		...
		//Une lo bytes de las sub-boxes y almacena
		for (i=0; i<32; i++) {
