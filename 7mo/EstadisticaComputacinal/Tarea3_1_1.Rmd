...
### Indica el tipo de variable e indica la escala de medición de cada variable.
...
### Elige una variable de este tipo y realiza una tabla de frecuencias que contenga frecuencias absolutas, frecuencias relativas y sus respectivas acumuladas; además de los totales. 
...
### Realiza el análisis gráfico adecuado para esta variable.
...
### Elige una variable de este tipo y realiza una tabla de frecuencias que contenga las frecuencias absolutas, frecuencias relativas y sus respectivas acumuladas; además de los totales. A partir de esta tabla identifica e indica claramente si la distribución es unimodal o multimodal.
...
### Elabora una gráfica adecuada con la que puedas describir el comportamiento de sus observaciones en términos de la dispersión, simetría y la posible existencia de valores atípicos. La gráfica debe incluir títulos y color.
